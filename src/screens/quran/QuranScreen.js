...
import { fitWidthForHeight } from '@/utils/quran/mushafLayout';
import { ayahPageForLayout, pageAyahsForLayout } from '@/utils/quran/mushafIndex';
import pagesData from '@assets/quran/data/pages.json';
import surahsData from '@assets/quran/data/surahs.json';
import ShareCardModal from '@/components/share/ShareCardModal';
import { loadQuranSettings, setQuranSettings, subscribeQuranSettings } from '@/utils/quran/QuranSettings';
import { buildAyahShareContent } from '@/utils/quran/quranShareContent';
...
import { useHdPrompt } from '@/hooks/quran/useHdPrompt';
import { useQuranAlerts } from '@/hooks/quran/useQuranAlerts';
import { useQuranAudioState } from '@/hooks/quran/useQuranAudioState';
import { useQuranBookmarks } from '@/hooks/quran/useQuranBookmarks';
import { useQuranPaging } from '@/hooks/quran/useQuranPaging';
import MushafListItem from '@/components/quran/MushafListItem';
import QuranMiniPlayer from '@/components/quran/QuranMiniPlayer';
import QuranVoiceFollowBar from '@/components/quran/QuranVoiceFollowBar';
import QuranIndexModal from '@/screens/quran/QuranIndexModal';
import QuranSearchModal from '@/screens/quran/QuranSearchModal';
import QuranAyahDetailSheet from '@/screens/quran/QuranAyahDetailSheet';
import QuranAyahActionSheet from '@/screens/quran/QuranAyahActionSheet';
import QuranSettingsModal from '@/screens/quran/QuranSettingsModal';
import QuranHdPromptModal from '@/screens/quran/QuranHdPromptModal';
import QuranPageInfoSheet from '@/screens/quran/QuranPageInfoSheet';
import QuranHeaderMenu from '@/screens/quran/QuranHeaderMenu';
