...
import { t, getDirectionalMixedSpacing } from '../../../core/i18n/i18n';
import { Feather } from '@expo/vector-icons';
import { useAudio } from '../../../common/utils/AudioManager';
import { TasbihBackground } from '../../../common/components/TasbihBackground';
...
export default function TasbihCounterScreen({ route, navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.BGreen }}>
      <TasbihBackground color={colors.BYellow} />
      <Modal
        animationType="slide"
        transparent={true}
        visible={mv}
      ...
      <AppHeader title={t('app.tasbih')} isHome={true} navigation={navigation} Left={() => {
