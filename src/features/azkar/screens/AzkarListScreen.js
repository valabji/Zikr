...
import { t, isRTL, getDirectionalMixedSpacing, getRTLTextAlign, getDirectionalSpacing } from '../../../core/i18n/i18n';
// import Azkar from '../constants/Azkar.js';
import { AntDesign, Feather, Ionicons } from '@expo/vector-icons';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { mystore } from '../../../core/store/store';
import { MuslimIcon } from '../../../common/components/MuslimIcon';
import { MuslimIconEnglish } from '../../../common/components/MuslimIconEnglish';
...
export default function AzkarListScreen({ navigation, route }) {
  ...
  const Item = ({ name, onPress, fav, index }) => {
    ...
    return <TouchableOpacity
      ...
      {isRTL() ? (
        <MuslimIcon color={colors.BYellow} backgroundColor={colors.DGreen} width={48} height={48} />
      ) : (
        <MuslimIconEnglish color={colors.BYellow} backgroundColor={colors.DGreen} width={48} height={48} />
      )}
      <View style={{
    ...
    return (
      <LinearGradient
        ...
        <View style={{ flexDirection: "row", position: "absolute", left: 0, top: 0, width, height: 64 }}>
          <HeaderBackground color={colors.DGreen + "55"} width={width} />
          <HeaderBackground color={colors.DGreen + "55"} width={width} />
        </View>
...
AzkarListScreen.navigationOptions = {
  header: null,
};
