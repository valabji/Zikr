...
} from '@/utils/quran/mushafLayout';
import { arForHafs } from '@/utils/quran/mushafText';
import QcfDownloader, { qcfFontFamilyForPage } from '@/utils/quran/QcfDownloader';
import translationEn from '@assets/quran/data/translation_en.json';
import SurahCartouche from '@/components/quran/SurahCartouche';
import { BismillahLine, MushafLine } from '@/components/quran/MushafLine';
