...
export const MuslimIconEnSvg = ({ color, backgroundColor, width = 48, height = 48, testID }) => {
  const brownColor = color || "rgb(148, 87, 30)"
  const greenColor = backgroundColor || "rgb(186, 218, 85)"
  ...
  return (
    ...
    >
      <Defs>
        <ClipPath id="muslimIconEnSlabClip">
      ...
      <Path
        ...
        fill={brownColor}
      />
      <G clipPath="url(#muslimIconEnSlabClip)">
        <Path
