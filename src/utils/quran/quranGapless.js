...
import QuranSurahDownloader from '@/utils/quran/QuranSurahDownloader';
import { QURAN_CONSTANTS } from '@/constants/QuranConstants';
import { pageAyahsForLayout, verseIndex } from '@/utils/quran/mushafIndex';
import { dlog, gaplessWordIdx } from '@/utils/quran/quranWordTiming';
